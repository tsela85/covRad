...
public class FMPlayerServiceWrapper {
	...
	private int setUpInnerMethods() {	
		try {
			...
			setMonoMethod = internalServiceClass.getMethod("setMono");
			setStereoMethod = internalServiceClass.getMethod("setStereo");
			...
			log("FMPlayerServiceWrapper - General exception: " + e.getMessage());
			return 0;
		}
	}
	...
	public void setMono() {		
		try {
			setMonoMethod.invoke(internalServiceObject);
		} catch (IllegalArgumentException e) {
			log("FMPlayerServiceWrapper - setMono - IllegalArgumentException: " + e.getMessage());
		} catch (IllegalAccessException e) {
			log("FMPlayerServiceWrapper - setMono - IllegalAccessException: " + e.getMessage());
		} catch (InvocationTargetException e) {
			log("FMPlayerServiceWrapper - setMono - InvocationTargetException: " + e.getMessage());
		}
	}
	
	public void setStereo() {		
		try {
			setStereoMethod.invoke(internalServiceObject);
		} catch (IllegalArgumentException e) {
			log("FMPlayerServiceWrapper - setStereo - IllegalArgumentException: " + e.getMessage());
		} catch (IllegalAccessException e) {
			log("FMPlayerServiceWrapper - setStereo - IllegalAccessException: " + e.getMessage());
		} catch (InvocationTargetException e) {
			log("FMPlayerServiceWrapper - setStereo - InvocationTargetException: " + e.getMessage());
		}
	}
